...
void Java_org_mozilla_gecko_vpn_core_NativeUtils_jniclose(JNIEnv *env,jclass jo, jint fd)
{
	int ret = close(fd);
}
...
jstring Java_org_mozilla_gecko_vpn_core_NativeUtils_getJNIAPI(JNIEnv *env, jclass jo)
{
